...
public class PortableMobItem extends BaseItem {
    ...
    public static final TagKey<EntityType<?>> BLACKLIST = TagKey.create(Registries.ENTITY_TYPES.getVanillaRegistry().key(), ResourceLocation.fromNamespaceAndPath("portablemobs", "capture_blacklist"));
