...
public class PortableMobsAdvancementGenerator extends AdvancementGenerator {
    ...
    public void generate() {
        ...
        this.advancement("playercaptureadvancement")
                ...
                .taskFrame()
                .parent("basiccelladvancement")
                .criterion("playertrigger", new PortableMobsSimpleTrigger.TriggerInstance(new ResourceLocation("portablemobs", "playercapture"), EntityPredicate.Composite.ANY));
        ...
        this.advancement("captureadvancement")
                ...
                .taskFrame()
                .parent("basiccelladvancement")
                .criterion("capture", new PortableMobsSimpleTrigger.TriggerInstance(new ResourceLocation("portablemobs", "capture"), EntityPredicate.Composite.ANY));
    }
}
